...
public class OrderRepository {
    ...
    public static List<Order> getAllOrder() throws Exception{
        ...
        for (Order order : listOrder) {
            ...
            order.setEmployee(EmployeeRepository.getById(order.getEmployeeId()));
            order.setShippingMethod(ShippingMethodRepository.getById(order.getShippingMethodId()));
            order.setListOrderDetail(OrderDetailRepository.getAllOrderByOrderId(order.get_id()));
        }
